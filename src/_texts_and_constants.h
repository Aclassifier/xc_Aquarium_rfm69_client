...
#define MY_MCP23008_OUT_RELAY2_ON_BIT               7
#define MY_MCP23008_OUT_RELAY1_ON_BIT               5
#define MY_MCP23008_OUT_WATCHDOG_LOWTOHIGH_EDGE_BIT 3
#define MY_MPC23008_IN_BUTTON_PRESS_WHENLOW_BIT     2
#define MY_MCP23008_OUT_RED_LED_OFF_BIT             1
#define MY_MCP23008_OUT_GREEN_LED_OFF_BIT           0
