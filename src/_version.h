...
#define RFM69_CLIENT_VERSION_STR "0.8.69"
#define RFM69_CLIENT_VERSION_NUM    0869
// 0869     10Feb2019           Common data structure session_transx_t now used with do_sessions_trans2to3
