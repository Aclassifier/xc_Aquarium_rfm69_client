...
XCC_FLAGS = -O2 -g -fxscope -save-temps -DMYTARGET=XCORE-200-EXPLORER -DISMASTER=1 -DWARNINGS=0
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_USER=3 
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_PAYLOAD_LEN08=40
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_DEBUG_PRINT_GLOBAL=1
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_DEBUG_PRINT_EXCEPTION=0
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_RADIO_IF_READALLREGS=0
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_GET_RADIO_DEBUG_REGS=0
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_SEMANTICS_DO_INTERMEDIATE_RECEIVEDONE=0 # Remove
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_SEMANTICS_DO_CRC_ERR_NO_IRQ=0 # Remove
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_I_RADIO_ANY=0 
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_TRANS=1
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_TRANS_ASYNCH_WRAPPED=1 # Only valid if above also 1
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_DEBUG_SHARED_LOG_VALUE=1
XCC_FLAGS += -D_USERMAKEFILE_LIB_RFM69_XC_DEBUG_FOREVER_LOOP=0
else
